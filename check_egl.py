...
def check_egl_support():
    try:
        ...
        if b"EGL_NV_device_cuda" in extensions or b"EGL_EXT_platform_device" in extensions:
             print("✅ NVIDIA EGL extensions found (Suitable for headless rendering).")
        else:
             print("⚠️ NVIDIA EGL extensions NOT found. You might fallback to software rendering.")
